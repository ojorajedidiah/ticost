      ...
      <div class="card-header">
        <div class="row">
          ...
          <div class="col-sm-4">
            ...
            <?php } else { ?>
              <a href="home.php?p=&v=new" class="btn btn-info float-right">Create New Product</a>
            <?php } ?>
          </div>
        </div>
      </div>
            ...
            <table id="grids" class="table table-bordered table-striped">
              <thead>
                <tr>
                  <th>Product Name</th>
                  <th>Product Image</th>
                  <th>Product Unit (Kg)</th>
                  <th>Product Quantity Unit (carton)</th>
